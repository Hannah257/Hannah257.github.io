...
function drawListToDOM() {
    ...
    var _loop_1 = function (index_1) {
         ...
         */
        todo.innerHTML = "<span class='check " + abc.todosChecked[index_1] + "'><i class='fas fa-check'></i></span>"
            + abc.todosText[index_1] +
    ...
    for (var index_1 = 0; index_1 < abc.todosText.length; index_1++) {
        _loop_1(index_1);
    }
    updateCounter();
}
function updateCounter() {
    var done = 0;
    var notdone = 0;
    for (var index_2 = 0; index_2 < abc.todosChecked.length; index_2++) {
        if (abc.todosChecked[index_2] == true) {
            done++;
        }
        else {
            notdone++;
